...
export class DonorHistoryComponent implements OnInit, OnDestroy {
  ...
  headerNames = [
    ...
    new DisplayVal(DonorViewRecord.prototype.age, 'Age'),
  ...
  ngOnInit(): void {
    if (this.isDonor()) {
      this.headerNames.push(
        ...
        new DisplayVal(DonorViewRecord.prototype.emergPhoneNumber, 'Emergency number')
      );
    }
    this.headerNames.push(
      new DisplayVal(DonorViewRecord.prototype.allergies, 'Allergies'),
      new DisplayVal(DonorViewRecord.prototype.diagnosis, 'Diagnosis'),
      new DisplayVal(DonorViewRecord.prototype.symptoms, 'Symptoms'),
      new DisplayVal(DonorViewRecord.prototype.treatment, 'Treatment'),
      new DisplayVal(DonorViewRecord.prototype.followUp, 'Followup duration')
    );
